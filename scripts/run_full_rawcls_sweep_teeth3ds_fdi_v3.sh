...
# Build on the best v2 setting (no rotate_z, no TTA) with additional knobs.
run_suite "configs/raw_cls/exp/teeth3ds_fdi_pretrain_supcon_norot_tta0_posfeat.yaml" "teeth3ds_fdi_pretrain_supcon_norot_tta0_posfeat"
run_suite "configs/raw_cls/exp/teeth3ds_fdi_pretrain_supcon_norot_tta0_unbal_ls0.yaml" "teeth3ds_fdi_pretrain_supcon_norot_tta0_unbal_ls0"
run_suite "configs/raw_cls/exp/teeth3ds_fdi_pretrain_supcon_norot_tta0_posfeat_unbal_ls0.yaml" "teeth3ds_fdi_pretrain_supcon_norot_tta0_posfeat_unbal_ls0"
