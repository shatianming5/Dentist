...
# Shared pretrain checkpoint (generated on demand).
...
# 1) Pretrain + SupCon (same as README SupCon, but init from Teeth3DS FDI).
run_suite "configs/raw_cls/exp/teeth3ds_fdi_pretrain_supcon.yaml" "teeth3ds_fdi_pretrain_supcon"

# 2) Aug/TTA mismatch probe: disable rotate_z + disable TTA.
run_suite "configs/raw_cls/exp/teeth3ds_fdi_pretrain_supcon_norot_tta0.yaml" "teeth3ds_fdi_pretrain_supcon_norot_tta0"

# 3) Fine-tuning style probes on CE finetune:
run_suite "configs/raw_cls/exp/teeth3ds_fdi_pretrain_finetune_freeze10.yaml" "teeth3ds_fdi_pretrain_finetune_freeze10"
run_suite "configs/raw_cls/exp/teeth3ds_fdi_pretrain_finetune_lr3e4.yaml" "teeth3ds_fdi_pretrain_finetune_lr3e4"
