...
CFG="configs/raw_cls/exp/teeth3ds_fdi_pretrain_supcon_rotz_tta8_posfeat_ls0_dropout0p1_seg_all_cloudid_eq_xyzonly_pointnet2_n1024_sa2_256.yaml"
EXP="teeth3ds_fdi_pretrain_supcon_rotz_tta8_posfeat_ls0_dropout0p1_seg_all_cloudid_eq_xyzonly_pointnet2_n1024_sa2_256"
MODEL="pointnet2"
...
python3 scripts/aggregate_runs.py \
  ...
  --out paper_tables/raw_cls_summary_v18_main4_seg_all_cloudid_eq_rotz_tta8_pointnet2_xyzonly_n1024_sa2_256.md \
  --seeds 1337,2020,2021 \
  --folds 0,1,2,3,4

echo "[$(date -u +%Y-%m-%dT%H:%M:%SZ)] DONE aggregate -> paper_tables/raw_cls_summary_v18_main4_seg_all_cloudid_eq_rotz_tta8_pointnet2_xyzonly_n1024_sa2_256.md"
